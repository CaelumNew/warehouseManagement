...
<body>
	...
	<div class="page-wrapper">
		<aside class="menu-sidebar2">
			<div class="logo">
                <a href="#">
                    <img src="images/icon/sushitei.png" alt="logo" />
                </a>
            </div>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap2">
                            <div class="logo d-block d-lg-none">
                                <a href="#">
                                    <img src="images/icon/sushitei.png" alt="st" />
                                </a>
                            </div>
                                ...
                                <div class="header-button-item has-noti js-item-menu">
                                    ...
                                    <div class="notifi-dropdown js-dropdown">
                                        ...
                                        <div class="notifi__item">
                                            ...
                                            <div class="content">
                                                <p>anda dapat email! , ini cuman contoh aja</p>
                                                <span class="date">April 12, 2023 06:50</span>
                                            </div>
                                        </div>
                                        <div class="notifi__item">
                                            ...
                                            <div class="content">
                                                <p>Akun anda telah berhasil diperbaharui!, ex</p>
                                                <span class="date">April 12, 2023 06:50</span>
                                            </div>
                                        </div>
                                        <div class="notifi__item">
